...
def create_realistic_business_card():
    ...
    draw.text((30, y_pos + 25), "SmartTech Innovation Co., Ltd.", fill='navy', font=font_info)
    y_pos += 70
    ...
    # 聯絡資訊
    draw.text((30, y_pos), "📧 ceo@smarttech-innovation.com.tw", fill='black', font=font_info)
    y_pos += 25
    ...
    y_pos += 25
    draw.text((30, y_pos), "🏢 台北市信義區信義路五段7號33樓", fill='black', font=font_info)
...
def main():
    ...
    if success:
        ...
        print("\n📋 接下來的步驟:")
        print("1. 【雲端部署】使用 Railway/Heroku 部署獲得穩定 URL")
