...
def create_test_business_card():
    ...
    # 職稱
    draw.text((20, y_pos), "技術經理 / Technical Manager", fill='black', font=font_medium)
    y_pos += 25
    
    # 聯絡資訊
    draw.text((20, y_pos), "📧 david.wang@techcorp.com.tw", fill='black', font=font_small)
    y_pos += 20
    ...
    draw.text((20, y_pos), "🏢 台北市信義區信義路五段7號", fill='black', font=font_small)
