...
async def test_ultra_fast_performance():
    ...
    try:
        ...
        from src.namecard.infrastructure.messaging.parallel_image_downloader import ParallelImageDownloader
        from src.namecard.infrastructure.ai.high_performance_processor import HighPerformanceCardProcessor
...
async def test_message_queue_performance():
    """測試訊息佇列性能"""
    try:
        from src.namecard.infrastructure.messaging.async_message_queue import AsyncMessageQueue, MessagePriority
