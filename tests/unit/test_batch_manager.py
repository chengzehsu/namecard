...
class TestBatchManager:
    ...
    def test_end_batch_mode_with_results(self):
        ...
        # 添加一些處理結果
        self.batch_manager.add_processed_card(
            self.test_user_id,
    ...
    def test_update_activity(self):
        ...
        original_time = self.batch_manager.user_sessions[self.test_user_id][
            "last_activity"
        ]
        time.sleep(0.1)  # 短暫延遲
    ...
    def test_cleanup_expired_sessions(self):
        ...
        self.batch_manager.user_sessions[expired_user][
            "last_activity"
    ...
    def test_concurrent_users(self):
        ...
        # 添加不同的處理結果
        self.batch_manager.add_processed_card(
            user1, {"name": "用戶1的名片", "company": "公司1", "notion_url": "url1"}
        )
        self.batch_manager.add_processed_card(
            user2, {"name": "用戶2的名片", "company": "公司2", "notion_url": "url2"}
        )
