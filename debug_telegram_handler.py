...
def test_config():
    ...
    try:
        ...
        print(f"✅ Config 載入成功")
        print(
            f"📋 TELEGRAM_BOT_TOKEN: {'已設置' if Config.TELEGRAM_BOT_TOKEN and Config.TELEGRAM_BOT_TOKEN != 'YOUR_TELEGRAM_BOT_TOKEN_HERE' else '未設置'}"
        )
        print(
            f"📋 GOOGLE_API_KEY: {'已設置' if Config.GOOGLE_API_KEY and Config.GOOGLE_API_KEY != 'YOUR_GOOGLE_API_KEY_HERE' else '未設置'}"
        )
        print(
            f"📋 NOTION_API_KEY: {'已設置' if Config.NOTION_API_KEY and Config.NOTION_API_KEY != 'YOUR_NOTION_API_KEY_HERE' else '未設置'}"
        )
