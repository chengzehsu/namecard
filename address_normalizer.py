...
class AddressNormalizer:
    ...
    def _normalize_simple(self, address: str) -> str:
        ...
        common_districts = [
            '信義', '大安', '中正', '松山', '萬華', '中山', '大同', '內湖', '南港', '士林', '北投', '文山',
            '板橋', '新莊', '中和', '永和', '土城', '樹林', '三重', '蘆洲', '五股', '泰山', '林口', '淡水',
            '中壢', '平鎮', '八德', '楊梅', '蘆竹', '龜山', '龍潭', '大溪', '大園', '觀音', '新屋',
            '西屯', '北屯', '南屯', '北區', '西區', '南區', '東區', '中區', '太平', '大里', '霧峰', '烏日',
            '前金', '新興', '左營', '鼓山', '三民', '苓雅', '前鎮', '小港', '旗津', '鳳山', '大寮', '林園'
        ]
    ...
    def _create_result(self, normalized: str, original: str, confidence: float, 
                      warnings: list, is_taiwan: bool) -> Dict[str, Any]:
        """創建結果字典"""
        return {
    ...
    def _extract_simple_components(self, address: str) -> Dict[str, str]:
        ...
        # 提取區域
        district_match = re.search(r'([^市縣][區鎮鄉市])', address)
        if district_match:
