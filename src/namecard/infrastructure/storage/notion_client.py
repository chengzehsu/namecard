...
class NotionManager:
    ...
    def create_name_card_record(self, card_data, image_bytes=None):
        ...
        try:
            ...
            return {"success": False, "error": f"建立 Notion 記錄失敗: {str(e)}"}
    ...
    def _add_image_info_to_page(self, page_id, image_bytes):
        ...
        try:
            ...
            if not success:
                # 方法2：創建空的圖片區塊供手動上傳
                self._create_image_placeholder_block(
                    page_id, image_bytes, image_size_kb
                )
    ...
    def _create_image_placeholder_block(self, page_id, image_bytes, image_size_kb):
        ...
        try:
            ...
            base64_preview = (
                image_base64[:200] + "..." if len(image_base64) > 200 else image_base64
            )
    ...
    def test_connection(self):
        ...
        try:
            ...
            return {
                "success": True,
                "database_title": database.get("title", [{}])[0]
                .get("text", {})
                .get("content", "Unknown"),
                "properties": list(database.get("properties", {}).keys()),
            }
        except Exception as e:
            return {"success": False, "error": f"Notion 連接測試失敗: {str(e)}"}
