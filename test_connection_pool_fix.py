...
class ConnectionPoolTester:
    ...
    async def test_telegram_client_fix(self):
        ...
        try:
            from namecard.infrastructure.messaging.telegram_client import TelegramBotHandler
    ...
    async def test_ultra_fast_processor_fix(self):
        ...
        try:
            from namecard.infrastructure.ai.ultra_fast_processor import UltraFastProcessor
    ...
    async def test_async_message_queue_fix(self):
        ...
        try:
            from namecard.infrastructure.messaging.async_message_queue import AsyncMessageQueue
